...
DRINKS = [
    ...
    {"season": "talvi", "tag": "Lämmittävä klassikko", "name": "Smoked Walker Old Fashioned",
     "ingredients": ["Johnnie Walker Black Label 4cl", "Demerara-siirappi 1cl", "Angostura Bitters 2 dashia"],
     "glass": "Tumbler", "garnish": "Savustettu appelsiininkuori",
     "method": "Sekoita baarilasissa jäiden kanssa n. 30 sekuntia, siivilöi tuoreen jääpalan päälle."},
    {"season": "talvi", "tag": "Ilta-annos", "name": "Baileys Espresso Martini",
     ...
     "method": "Ravista sheikkerissä jäiden kanssa n. 15 sekuntia, siivilöi kylmään lasiin."},
    {"season": "talvi", "tag": "Comfort drink", "name": "Bulleit Hot Toddy",
     ...
     "method": "Sekoita ainekset suoraan lämpimään lasiin, tarjoile heti."},
    {"season": "talvi", "tag": "Juhlava", "name": "Tanqueray Winter Sour",
     "ingredients": ["Tanqueray London Dry Gin 4cl", "Sitruunamehu 2cl", "Siirappi 1,5cl", "Valkuainen 1kpl"],
     "glass": "Coupe-lasi", "garnish": "Rouhittu mustapippuri",
     "method": "Ravista ensin ilman jäitä (dry shake), sitten uudelleen jäiden kanssa, siivilöi lasiin."},
    # Kevät
    {"season": "kevät", "tag": "Kausituote", "name": "Ketel One Rhubarb Collins",
     "ingredients": ["Ketel One Vodka 4cl", "Rabarperisiirappi 2cl", "Sitruunamehu 1,5cl", "Sooda täytteeksi"],
     "glass": "Collins-lasi", "garnish": "Rabarperitikku",
     "method": "Rakenna suoraan lasiin jäiden kanssa, täytä soodalla, sekoita kevyesti."},
    {"season": "kevät", "tag": "Raikas", "name": "Tanqueray Herb Fizz",
     "ingredients": ["Tanqueray London Dry Gin 4cl", "Sitruunamehu 2cl", "Siirappi 1,5cl", "Sooda täytteeksi"],
     "glass": "Highball-lasi", "garnish": "Tuore tilli",
     "method": "Ravista perusaineet sheikkerissä jäiden kanssa, siivilöi lasiin jäiden päälle, täytä soodalla."},
    {"season": "kevät", "tag": "Kevyt", "name": "Don Julio Blanco Paloma",
     "ingredients": ["Don Julio Blanco Tequila 4cl", "Greippisooda 8cl", "Limemehu 1cl"],
     "glass": "Highball-lasi", "garnish": "Suolareunus, limettiviipale",
     "method": "Rakenna suoraan lasiin jäiden kanssa, sekoita kevyesti."},
    {"season": "kevät", "tag": "Yrttinen", "name": "Ketel One Basil Smash",
     "ingredients": ["Ketel One Vodka 4cl", "Sitruunamehu 1,5cl", "Siirappi 1cl", "Tuore basilika 6 lehteä"],
     "glass": "Tumbler", "garnish": "Basilikanoksa",
     "method": "Muserra basilika lasin pohjalle, ravista loput ainekset sheikkerissä jäiden kanssa, siivilöi lasiin jäiden päälle."},
    # Kesä
    {"season": "kesä", "tag": "Low & no", "name": "Seedlip Garden Spritz",
     ...
     "method": "Rakenna suoraan lasiin jäiden kanssa, sekoita kevyesti. Alkoholiton vaihtoehto listalle."},
    {"season": "kesä", "tag": "Terassiklassikko", "name": "Johnnie Walker Highball",
     ...
     "method": "Rakenna suoraan lasiin jäiden kanssa, kaada viski, täytä soodalla varovasti sekoittaen."},
    {"season": "kesä", "tag": "Kesäjuhla", "name": "Don Julio Watermelon Margarita",
     "ingredients": ["Don Julio Blanco Tequila 4cl", "Tuore vesimelonimehu 4cl", "Limemehu 2cl", "Agavesiirappi 1cl"],
     "glass": "Margarita-lasi", "garnish": "Suolareunus, vesimelonipala",
     "method": "Ravista kaikki ainekset sheikkerissä jäiden kanssa, siivilöi lasiin jäiden päälle."},
    {"season": "kesä", "tag": "Raikas", "name": "Ketel One Cucumber Collins",
     "ingredients": ["Ketel One Vodka 4cl", "Kurkkumehu 3cl", "Limemehu 1,5cl", "Sooda täytteeksi"],
     "glass": "Collins-lasi", "garnish": "Kurkkuviipale",
     "method": "Rakenna suoraan lasiin jäiden kanssa, täytä soodalla."},
    # Syksy
    {"season": "syksy", "tag": "Syksyn suosikki", "name": "Captain Morgan Spiced Mule",
     "ingredients": ["Captain Morgan Spiced Gold 4cl", "Inkiväärikaljaa 8cl", "Limemehu 1cl"],
     "glass": "Kuparimuki tai highball", "garnish": "Savustettu rosmariininoksa",
     "method": "Rakenna suoraan lasiin jäiden kanssa, täytä inkiväärikaljalla."},
    {"season": "syksy", "tag": "Kausituote", "name": "Johnnie Walker Apple Old Fashioned",
     "ingredients": ["Johnnie Walker Black Label 4cl", "Omenasiirappi 1,5cl", "Angostura Bitters 2 dashia"],
     "glass": "Tumbler", "garnish": "Omenaviipale, kaneli",
     "method": "Sekoita baarilasissa jäiden kanssa n. 30 sekuntia, siivilöi tuoreen jääpalan päälle."},
    {"season": "syksy", "tag": "Ylellinen", "name": "Casamigos Fig & Walnut Old Fashioned",
     "ingredients": ["Casamigos Reposado Tequila 4cl", "Viikunasiirappi 1,5cl", "Angostura Bitters 2 dashia"],
    ...
    {"season": "syksy", "tag": "Mausteinen", "name": "Baileys Chai Espresso Martini",
     ...
     "method": "Ravista sheikkerissä jäiden kanssa, siivilöi kylmään lasiin."},
]
